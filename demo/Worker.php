...
class Worker
{
    ...
    public static function runAll()
    {
        ...
        //守护进程
        static::daemonize();
        static::initWorkers();//建立监听
        static::installSignal();
        static::saveMasterPid();
        static::unlock();
        static::displayUI();
        static::forkWorkers();//fork子进程
        static::resetStd();//重置输出
...
//        stream_context_set_option 设置参数
//        stream_socket_enable_crypto  - 在已连接的套接字上打开/关闭加密
//        stream_socket_server 创建socket
//        socket_set_option
//        set_error_handler 错误处理函数
//        restore_error_handler 在通过set_error_handler() 函数更改错误处理函数之后对其进行恢复
